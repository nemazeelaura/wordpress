...
<div class="flypanels-main">	
	...
	<header class="wpcrt-header-container">		
		...
		<?php $stickyheader     = wp_iclean_responsive_get_theme_mod( 'stickyheader' );	 ?>	
		<div class="wpcrt-header" data-sticky-container>
			<div class="header-inner " <?php echo (!empty($stickyheader))?'data-sticky' : '' ?> data-options="marginTop:0;">
					<div class="header_wrap row" >
	...
	?>
                        <div class="wpcrt-inner-header <?php echo esc_attr($feat_cls); ?>" <?php echo $feat_style; ?> >
