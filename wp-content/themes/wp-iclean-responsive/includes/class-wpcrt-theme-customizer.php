...
function wp_iclean_responsive_customize_register( $wp_customize ) {
	...
	***************************************/
	...
	$wp_customize->add_section(
		'wp_iclean_responsive_header_section', array(
			'title'    => __( 'Header Settings', 'wp-iclean-responsive' ),
			'priority' => 1,
		)
	);
	...
	$wp_customize->add_setting(
			'stickyheader', array(
				...
				'transport'         => 'refresh',				
				'default'       => $wp_iclean_responsive_options['stickyheader'],
			)
	);

	$wp_customize->add_control(
		'stickyheader', array(
			'label'    		=> __( 'Enable Sticky Header', 'wp-iclean-responsive' ),
			'description'   => __( 'If Enabled, Header will sticky', 'wp-iclean-responsive' ),
			'section' 		=> 'wp_iclean_responsive_header_section',
	...
	$wp_customize->add_setting(
		'logo_width', array(
			...
			'transport'         => 'refresh',
			'default' 	   		=> $wp_iclean_responsive_options['logo_width'],
		)
	);

	$wp_customize->add_control(
		'logo_width', array(
			'label'    		=> __( 'Logo Width', 'wp-iclean-responsive' ),
			'section'  		=> 'wp_iclean_responsive_header_section',
			'description'   => __( 'Incase of sticky header, set logo width Eg:- 200', 'wp-iclean-responsive' ),
			'type'     		=> 'number',
		)
	);	
...
function wp_iclean_responsive_customize_colors() {		
		...
		//logo width
		$logo_width = wp_iclean_responsive_get_theme_mod( 'logo_width' );
