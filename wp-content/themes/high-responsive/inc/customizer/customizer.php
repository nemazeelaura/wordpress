...
function highresponsive_customize_preview_js() {
	wp_enqueue_script( 'highresponsive-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.min.js', array( 'customize-preview' ), '20170816', true );
}
