...
class Highresponsive_Metabox {
	...
	*/
	...
	public function enqueue_metabox_scripts( $hook ) {
	    ...
	    //Scripts
		wp_enqueue_script( 'highresponsive-metabox-script', get_template_directory_uri() . '/inc/metabox/metabox.js', array( 'jquery', 'jquery-ui-tabs' ), '2017-08-15' );

		//CSS Styles
		wp_enqueue_style( 'highresponsive-metabox-style', get_template_directory_uri() . '/inc/metabox/metabox.css' );
	}
}
