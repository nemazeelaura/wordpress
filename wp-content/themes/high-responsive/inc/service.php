...
if ( ! function_exists( 'highresponsive_service_display' ) ) :
	...
	*/
	function highresponsive_service_display() {
		...
		$enable_content = get_theme_mod( 'highresponsive_service_option', 'homepage' );
	...
	function highresponsive_post_page_category_service() {
		...
		while ( $loop->have_posts() ) {
			...
			$output .= '
				...
				$image = '<img class="wp-post-image" src="' . esc_url( trailingslashit( get_template_directory_uri() ) ) . 'assets/images/no-thumb.jpg" >';
